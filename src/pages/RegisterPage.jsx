    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
         <div className="max-w-4xl w-full space-y-5">
           ...
           <div className="text-center">
             ...
             >
               Sign up for support as an initiative or family
             </motion.p>
           </div>
           ...
           <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
             ...
             >
               <div className="p-8 text-center">
                 ...
                 <h2 className="text-2xl font-semibold text-gray-900 mb-3">Donors</h2>
                 ...
                 <div className="mt-6 inline-flex items-center text-blue-600 group-hover:text-blue-700">
                   <span className="font-medium">Apply as Donors</span>
             ...
             >
               <div className="p-8 text-center">
                 ...
                 <h2 className="text-2xl font-semibold text-gray-900 mb-3">Beneficiary</h2>
                 <p className="text-gray-600">
                 ...
                 <div className="mt-6 inline-flex items-center text-green-600 group-hover:text-green-700">
                   <span className="font-medium">Apply as Beneficiary</span>
                   <svg className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" 
                     fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} 
                       d="M9 5l7 7-7 7" />
